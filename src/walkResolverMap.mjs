import { ResolverMapStumble } from './errors/index.mjs'
import { isFn, getType } from './utils/typework.mjs'
import at from './propAt.mjs'
 ...
 */
export function walkResolverMap(object, inspector, wrap, path) {
  let product = {}
